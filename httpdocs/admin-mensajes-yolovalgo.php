...
<div  class="divContenedor" style='padding: 20px;margin: 0px; border-top: 0px;'>
	...
	<div style='width:45%; float: left;'>
			...
			<label for="check1">  <i class="fa fa-inbox"></i> <i class="fa fa-reply"></i> Mensajes Yolovalgo</label>
			<div class="texto">
				...
				<div style='height: 300px; overflow:auto;'>		
						...
						<?
							...
							$consulta="Select mail.id,mail.fecha,mail.from,mail.asunto,mail.news,usuarios.subdominio 
										from mail,usuarios 
										where  (usuarios.usuario=mail.from) and mail.from  LIKE 'info@yolovalgo.com'   and   `to`='".$campo['usuario']."' order by news ASC, id DESC LIMIT 100;"; 
